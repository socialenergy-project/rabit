class PagesController < ApplicationController
  def home
    @cards = [
      { message: "#{Message.where(recipient: current_user).count} Messages", color: "bg-primary", link: messages_path, image: "fa-comments" },
      ...
      { message: "#{UserClusteringScenario.count} User Clustering Scenarios", color: "bg-success", link: user_clustering_scenarios_path, image: "fa-users" },
    ]
